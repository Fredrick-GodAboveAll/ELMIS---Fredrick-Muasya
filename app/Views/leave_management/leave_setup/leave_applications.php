<?php $currentPage = 'leave_applications'; ?>
      ...
      <div class="card-header">
        <div class="row flex-between-center">
          <div class="col-6 col-sm-auto d-flex align-items-center pe-0">
            <h5 class="fs-9 mb-0 text-nowrap py-2 py-xl-0">Leave Applications</h5>
          </div>
        ...
        <table class="table table-sm mb-0 overflow-hidden data-table fs-10"
          ...
          <thead class="bg-200">
            <tr>
              ...
              <!-- KEEP ACTIONS -->
              <th class="text-900 no-sort pe-1 align-middle data-table-row-action"
              ...
              <td class="align-middle white-space-nowrap text-end">
                <div class="dropstart font-sans-serif position-static d-inline-block">
                  ...
                  <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end"
                    type="button"
                    id="dropdown-simple-pagination-table-item-0"
