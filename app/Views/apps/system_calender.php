<?php $currentPage = 'system_calender'; ?>
...
<div class="row g-3 mb-3">
  <div class="col-xxl-12 col-xl-12">
    <div class="card">
      ...
      <div class="card-body">
        <!-- Your content -->
        <p>Your page content goes here Timing Purposes.</p>
      </div>
    </div>
  </div>
</div>
            ...
            <div class="card-header">
              <div class="row gx-0 align-items-center">
                ...
                <div class="col d-flex justify-content-end order-md-2">
                  <div class="dropdown font-sans-serif me-md-2"><button class="btn btn-falcon-default text-600 btn-sm dropdown-toggle dropdown-caret-none" type="button" id="email-filter" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span data-view-title="data-view-title">Month View</span><span class="fas fa-sort ms-2 fs-10"></span></button>
