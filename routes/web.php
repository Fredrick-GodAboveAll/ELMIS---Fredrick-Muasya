...
$router->get('/leave-entitlements', 'LeaveController@LeaveEntitlement', [AuthMiddleware::class]);
$router->get('/leave-entitlements/detail', 'LeaveController@LeaveEntitlementDetail', [AuthMiddleware::class]);
